...
#ifndef MY_ROBOT_INTERFACES__ACTION__RUN_MOTOR_PROFILE_H_
#define MY_ROBOT_INTERFACES__ACTION__RUN_MOTOR_PROFILE_H_
...
#endif  // MY_ROBOT_INTERFACES__ACTION__RUN_MOTOR_PROFILE_H_
